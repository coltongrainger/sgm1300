...
## Mitchel T. Keller                                                     ##
##                                                                       ##
## This file is part of The PreTeXt Basics Reference (The sgm1300).          ##
##                                                                       ##
...
## along with The sgm1300. If not, see <http://www.gnu.org/licenses/>.       ##
## ********************************************************************* ##
...
images: sgm1300-merge
	...
	install -d $(IMAGESOUT)
	-rm $(IMAGESOUT)/*.svg
	$(PTX)/script/mbx -c latex-image -f all -d $(IMAGESOUT) $(OUTPUT)/sgm1300-merge.ptx
...
pdf: sgm1300-merge
	...
	cd $(PDFOUT); \
	xsltproc -o ${MAINFILE%*.}.tex -xinclude -stringparam numbering.theorems.level 1 -stringparam numbering.projects.level 1 -stringparam numbering.equations.level 1 $(PTXXSL)/mathbook-latex.xsl $(WWOUT)/sgm1300-merge.ptx; \
	$(ENGINE) ${MAINFILE%*.}; \
	$(ENGINE) ${MAINFILE%*.}
